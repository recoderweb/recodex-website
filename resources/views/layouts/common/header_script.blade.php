...
<!-- Windows Phone -->
<meta name="msapplication-navbutton-color" content="#86C232">
<!-- iOS Safari -->
<meta name="apple-mobile-web-app-status-bar-style" content="#86C232">
...
<link rel="stylesheet" href="{{ asset('fonts/custom-font/css/clash-display.css') }}" />
<link rel="stylesheet" href="{{ asset('fonts/bootstrap-icons/font-css.css') }}" />
