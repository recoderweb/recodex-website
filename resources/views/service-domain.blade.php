        ...
        <div class="container">
            <div class="row gx-4 gx-xxl-5 align-items-center">
                <div class="col-xl-12 col-md-10">
                    <div class="theme__content__two text-center mb-45">
                        <h4 class="hero-sub-title mb-25">Registrasi Domain terpercaya bersama kami!</h4>
                        <h1 class="main-title-two">
                            Cek Domain <span>Murah</span> dan Beli Sekarang
                        </h1>
                        <div class="contact-form-two">
                            <form action="" method="POST" class="sub-form">
                                <input type="text" placeholder="Email">
                                <button class="domain px-5" type="submit">Cek Domain</button>
                            </form>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-8 offset-md-2">
                    <div class="card text-dark">
                        ...
                        <div class="card-body">
                            <p><strong>Domain ID: </strong>PANDI-DO9108036</p>
                            <p><strong>Domain Name: </strong>recodex.id</p>
                            <p><strong>Created On: </strong>2024-03-07 14:05:03</p>
                            <p><strong>Last Updated On: </strong>2024-03-07 14:05:07</p>
                            <p><strong>Expiration Date: </strong>2025-03-07 23:59:59 </p>
                            <p><strong>Status: </strong>serverTransferProhibited</p>
                            <p><strong>Status: </strong>clientTransferProhibited</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row gx-4 gx-xxl-5 align-items-center justify-content-center">
                <div class="col-xl-12 col-lg-10 col-md-8">
                    <div class="section-title text-center mb-35">
                        <h3 class="sect-title mb-25">Daftar Domain Murah Indonesia Terpopuler</h3>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row gx-3 gx-xxl-6">
                        ...
                        <div class="col-lg-3 col-md-6" data-aos="fade-left" data-aos-delay="100">
                            <div class="plan mb-45">
                                <div class="plan__header">
                                    <h3>.com</h3>
                                    <p>Ekstensi domain terbaik dan paling populer di dunia</p>
                                </div>
                                <div class="plan__price">
                                    Rp 250.000
                                    <sub>/bln</sub>
                        ...
                        <div class="col-lg-3 col-md-6" data-aos="fade-left" data-aos-delay="100">
                            <div class="plan mb-45">
                                <div class="plan__header">
                                    <h3>.online</h3>
                                    <p>Ekstensi yang sesuai dengan keperluan online Anda</p>
                                </div>
                                <div class="plan__price">
                                    Rp 250.000
                                    <sub>/bln</sub>
                        ...
                        <div class="col-lg-3 col-md-6" data-aos="fade-left" data-aos-delay="100">
                            <div class="plan mb-45">
                                <div class="plan__header">
                                    <h3>.io</h3>
                                    <p>Tunjukkan bahwa Anda siap online dengan .io</p>
                                </div>
                                <div class="plan__price">
                                    Rp 250.000
                                    <sub>/bln</sub>
                    ...
                    <div class="row gx-3 gx-xxl-6">
                        <div class="col-lg-3 col-md-6" data-aos="fade-left" data-aos-delay="100">
                            <div class="plan mb-45">
                                <div class="plan__header">
                                    <h3>.icu</h3>
                                    <p>Sebarluaskan bisnis Anda dengan domain .icu</p>
                                </div>
                                <div class="plan__price">
                                    Rp 250.000
                                    <sub>/bln</sub>
                        ...
                        <div class="col-lg-3 col-md-6" data-aos="fade-left" data-aos-delay="100">
                            <div class="plan mb-45">
                                <div class="plan__header">
                                    <h3>.xyz</h3>
                                    <p>Ekstensi domain unik yang bisa Anda gunakan untuk website</p>
                                </div>
                                <div class="plan__price">
                                    Rp 250.000
                                    <sub>/bln</sub>
                        ...
                        <div class="col-lg-3 col-md-6" data-aos="fade-left" data-aos-delay="100">
                            <div class="plan mb-45">
                                <div class="plan__header">
                                    <h3>.me</h3>
                                    <p>Lebih personal menggunakan nama domain .me</p>
                                </div>
                                <div class="plan__price">
                                    Rp 250.000
                                    <sub>/bln</sub>
                        ...
                        <div class="col-lg-3 col-md-6" data-aos="fade-left" data-aos-delay="100">
                            <div class="plan mb-45">
                                <div class="plan__header">
                                    <h3>.cloud</h3>
                                    <p>Tunjukkan bahwa bisnis Anda eksis dengan .cloud</p>
                                </div>
                                <div class="plan__price">
                                    Rp 250.000
                                    <sub>/bln</sub>
